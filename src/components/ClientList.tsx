                    ...
                    setFormData({ name: '', clientNumber: '', prgd: '', phone: '', currentStageId: STAGES[0].id, deliveryDate: '' }); 
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <input required className="w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl font-bold outline-none focus:bg-white" placeholder="(62) 99999-9999 ou +33..." value={formData.phone} onChange={e => setFormData({...formData, phone: formatPhone(e.target.value)})} />
                        </div>
                        <div>
